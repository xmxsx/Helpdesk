  ...
  <div class="admin-page">
    ...
    <div class="main-content">
      <nav class="sidebar">
        <ul>
          <li>
            <NuxtLink to="/admin/dashboard" :class="{ active: currentSection === 'dashboard' }" @click="changeSection('dashboard')">Dashboard</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/admin/users" :class="{ active: currentSection === 'users' }" @click="changeSection('users')">Users</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/admin/settings" :class="{ active: currentSection === 'settings' }" @click="changeSection('settings')">Settings</NuxtLink>
          </li>
        </ul>
      </nav>
      <div class="content">
        ...
        <div v-else class="ticket-details">
          ...
          <div class="details-body">
            <div class="details-column-left">
              ...
              <p><span>Status:</span>
                <select v-model="selectedTicket.status" @change="isStatusChanged = true" class="status-select">
          ...
          <div class="details-footer">
            <div class="details-buttons">
              ...
              <button v-if="isStatusChanged" class="save-button" @click="updateTicketStatus">Save</button>
